    ...
    <div>
      <div className="mt-[100px]">
        ...
        <div className="flex flex-wrap flex-col ">
          <div className="flex flex-wrap flex-row space-x-10 justify-center items-center  ">
          ...
          <div className="flex flex-wrap flex-row justify-center items-center space-x-10 mt-5">
            <div className="relative">
              <img
                className="h-[400px] w-[600px] transition duration-500 hover:opacity-50"
                src={Image15}
      ...
      <div className="flex flex-wrap justify-center">
        <a href="https://github.com/carren-chepkorir" className="href">
          {" "}
          <button className="bg-orange-500 rounded-full items-center text-white py-5 px-6  mt-10">
            See All My Projects
          </button>
        </a>
      </div>
